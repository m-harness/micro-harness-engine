...
<p align="center">
  ...
  <p align="center">
    ...
    <a href="./docs/ja/index.md">Documentation</a> ·
    <a href="./docs/ja/getting-started.md">Getting Started</a>
  </p>
</p>
...
詳しくは [Getting Started](./docs/ja/getting-started.md) を参照。
...
| ドキュメント | 内容 |
|---|---|
| **[Getting Started](./docs/ja/getting-started.md)** | インストール・初期設定・最初のチャットまで |
| **[Architecture](./docs/ja/architecture.md)** | システム全体の構成・コンポーネント・処理フロー |
| **[Security Model](./docs/ja/security.md)** | 3層防壁・Protection Engine・機密情報検出 |
| **[Policy Guide](./docs/ja/policy-guide.md)** | Tool Policy / File Policy の仕組みと設定方法 |
| **[Agent Loop](./docs/ja/agent-loop.md)** | エージェントループ・承認ワークフロー・自動リカバリ |
| **[Tools](./docs/ja/tools.md)** | ビルトインツール一覧・プラグイン開発ガイド |
| **[MCP Integration](./docs/ja/mcp-guide.md)** | MCPサーバー接続・設定・管理 |
| **[Admin Guide](./docs/ja/admin-guide.md)** | 管理画面の全機能解説 |
| **[Configuration](./docs/ja/configuration.md)** | 全環境変数・設定リファレンス |
| **[API Reference](./docs/ja/api-reference.md)** | REST API 全エンドポイント |
| **[Data Model](./docs/ja/data-model.md)** | データベーススキーマ・ER図 |
